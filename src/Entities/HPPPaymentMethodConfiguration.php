...
class HPPPaymentMethodConfiguration
{
    ...
    {
        $this->authentications = new HPPAuthenticationConfiguration();
        $this->apm = new HPPApmConfiguration();
        $this->storageMode = HPPStorageModes::PROMPT;
        $this->digitalWallets = null;
    }
