...
use GlobalPayments\Api\Entities\Enums\{HPPFunctions, HPPTypes, YesNoEnum};
...
class HPPDataTest extends TestCase
{
    ...
    public function testCanInstantiate()
    {
        ...
        $this->assertEquals(YesNoEnum::NO, $this->hppData->shippable);
    ...
    {
        $this->hppData->shippable = YesNoEnum::YES;
    ...
    {
        $this->hppData->shippable = YesNoEnum::NO;
    ...
    public function testIsValidReturnsTrueWhenValid()
    {
        ...
        $this->hppData->shippable = YesNoEnum::NO; // Ensure shippable is properly set
    ...
    public function testCompleteHPPDataSetup()
    {
        ...
        $this->assertEquals(YesNoEnum::YES, $this->hppData->shippable);
